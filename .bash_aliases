...
alias pp="gnome-pomodoro-tracking --projects"
alias pps="gnome-pomodoro-tracking --projects --set "
alias pw="gnome-pomodoro-tracking --workspaces"
alias pws="gnome-pomodoro-tracking --workspaces --set "
